...
# Database: elastacart.local
# Generation Time: 2019-03-22 01:10:58 +0000
# ************************************************************
...
INSERT INTO `api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`)
VALUES
	(1,'Default','',1,'2019-03-21 21:08:18','2019-03-21 21:08:18');
...
INSERT INTO `cron` (`cron_id`, `code`, `cycle`, `action`, `status`, `date_added`, `date_modified`)
VALUES
...
INSERT INTO `custom_field` (`custom_field_id`, `type`, `value`, `validation`, `location`, `status`, `sort_order`)
VALUES
...
INSERT INTO `custom_field_customer_group` (`custom_field_id`, `customer_group_id`, `required`)
VALUES
	(1,1,1),
	(2,1,1),
	(3,1,1),
...
INSERT INTO `custom_field_description` (`custom_field_id`, `language_id`, `name`)
VALUES
	(1,1,'Select'),
	(2,1,'Radio'),
	(3,1,'Checkbox'),
...
INSERT INTO `custom_field_value` (`custom_field_value_id`, `custom_field_id`, `sort_order`)
VALUES
	(1,1,1),
	(2,1,2),
	(3,1,3),
...
INSERT INTO `custom_field_value_description` (`custom_field_value_id`, `language_id`, `custom_field_id`, `name`)
VALUES
	(1,1,1,'Test 1'),
	(2,1,1,'test 2'),
	(3,1,1,'Test 3'),
...
# Dump of table customer_affiliate
# ------------------------------------------------------------
...
# Dump of table customer_affiliate_report
# ------------------------------------------------------------
...
# Dump of table customer_approval
# ------------------------------------------------------------
...
INSERT INTO `event` (`event_id`, `code`, `trigger`, `action`, `status`, `sort_order`)
VALUES
...
# Dump of table extension_install
# ------------------------------------------------------------
...
INSERT INTO `geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`)
VALUES
...
INSERT INTO `language` (`language_id`, `name`, `code`, `locale`, `image`, `sort_order`, `status`)
VALUES
...
# Dump of table marketing_report
# ------------------------------------------------------------
...
# Dump of table seo_regex
# ------------------------------------------------------------

DROP TABLE IF EXISTS `seo_regex`;

CREATE TABLE `seo_regex` (
...
LOCK TABLES `seo_regex` WRITE;
/*!40000 ALTER TABLE `seo_regex` DISABLE KEYS */;

INSERT INTO `seo_regex` (`seo_regex_id`, `name`, `regex`, `sort_order`)
VALUES
...
INSERT INTO `seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`, `push`)
VALUES
...
VALUES
	...
	(210,0,'config','config_api_id','1',0),
	...
	(208,0,'config','config_email','lucasjkr@me.com',0),
	...
	(209,0,'config','config_encryption','',0),
...
# Dump of table shipping_courier
# ------------------------------------------------------------
...
INSERT INTO `shipping_courier` (`shipping_courier_id`, `shipping_courier_code`, `shipping_courier_name`)
VALUES
	(1,'dhl','DHL'),
	(2,'fedex','Fedex'),
	(3,'ups','UPS'),
...
INSERT INTO `statistics` (`statistics_id`, `code`, `value`)
VALUES
	(1,'order_sale',0.0000),
...
VALUES
	(1,1,'admin','$2y$10$s5Ws/WQLtvHLMf.937LuJuCc5w/k558m54xE6ikZQqp7v62DfNoSC','','John','Doe','admin@example.com','','','',1,'2019-03-21 21:08:18');
